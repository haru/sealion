...
- TypeScript 5 / Node.js 20 LTS + Next.js 16 (App Router), MUI v6, next-intl 4, Prisma 7, axios (011-close-issue-modal)
- PostgreSQL 16 via Prisma 7 — no schema changes required (011-close-issue-modal)
