...
- TypeScript 5 / Node.js 20 LTS + Next.js 16 (App Router), MUI v6, Auth.js v5, Prisma 7, next-intl 4, `@dnd-kit/core` + `@dnd-kit/sortable`（新規追加） (006-today-tasks)
- PostgreSQL 16 via Prisma ORM（Issue テーブルにカラム追加） (006-today-tasks)
