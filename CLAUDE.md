...
- TypeScript 5 / Node.js 20 LTS + Next.js 16 (App Router), React, MUI v7, next-intl 4, Jest, Playwright (010-sync-throttle)
- PostgreSQL 16 via Prisma 7 — no schema changes needed (010-sync-throttle)
