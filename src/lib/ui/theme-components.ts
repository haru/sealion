...
export const components: Components<ThemeOptions> = {
  MuiCssBaseline: {
  ...
  MuiChip: {
    styleOverrides: {
      root: { fontSize: "0.6875rem", height: 20, borderRadius: 4, fontWeight: 500 },
      outlined: { borderColor: "#e5e7eb", color: "#6b7280", backgroundColor: "transparent" },
      sizeSmall: { height: 20, fontSize: "0.6875rem" },
      icon: { marginLeft: 6, marginRight: -2 },
  ...
  MuiListItemIcon: {
    styleOverrides: { root: { minWidth: 32, color: "#6b7280" } },
  },
  MuiListItemText: {
    styleOverrides: { primary: { fontSize: "0.875rem", fontWeight: 500, color: "#374151" } },
  },
  MuiIconButton: {
    styleOverrides: {
      root: {
  ...
  MuiOutlinedInput: {
    styleOverrides: {
      root: {
        ...
        "&.Mui-focused .MuiOutlinedInput-notchedOutline": { borderColor: "#4f46e5", borderWidth: 1 },
      },
  ...
  MuiTooltip: {
    styleOverrides: {
      tooltip: { fontSize: "0.75rem", backgroundColor: "#1f2937", borderRadius: 4, padding: "4px 8px" },
    },
  },
  MuiDialog: {
    styleOverrides: {
  ...
  MuiAlert: { styleOverrides: { root: { borderRadius: 8, fontSize: "0.875rem" } } },
  MuiSnackbar: {
    styleOverrides: {
      root: {
        "& .MuiAlert-root": {
  ...
  MuiLinearProgress: { styleOverrides: { root: { borderRadius: 4, backgroundColor: "#e5e7eb" } } },
  MuiTableCell: {
    styleOverrides: {
  ...
  MuiPagination: {
    styleOverrides: {
      root: {
        "& .MuiPaginationItem-root": { borderRadius: 6, fontSize: "0.8125rem" },
      },
    },
  },
